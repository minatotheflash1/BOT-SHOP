...
// 🔥 RIDER DELIVER ORDER + 50 TK COMMISSION
...
// 🔥 NEW: RIDER WITHDRAW API (300 BDT LIMIT)
app.post('/api/rider/withdraw', async (req, res) => {
    ...
    try {
        ...
        if (!rider || rider.walletBalance < amount || amount < 300) return res.json({ success: false, error: 'Minimum withdrawal amount is ৳300.' });
